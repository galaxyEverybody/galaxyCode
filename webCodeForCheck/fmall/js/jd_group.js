...
$(function(){
	...
	/*
	$(".brand-wrap ul.brand li").mouseenter(function(){
		$(this).addClass("curr");
	})
	
	$(".brand-wrap ul.brand li").mouseleave(function(){
		$(this).removeClass("curr");
	})
	
	$("#group_title li").click(function(){
		var i = $("#group_title li").index($(this));
		$("#group_title li").removeClass("curr");
		$(this).addClass("curr");
