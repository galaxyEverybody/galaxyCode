...
?>
                        <li class="li1<?php if ($this->_var['id'] == $this->_var['item']['article_id']): ?> sell<?php endif; ?>"> <a href="<?php echo $this->_var['item']['url']; ?>" target="_self"><?php echo $this->_var['item']['short_title']; ?></a> </li>
        ...
        <div class="right">
        	<div class="urHere"><?php echo $this->fetch('library/ur_here.lbi'); ?></div>
            <div class="articleCon">
                <h3 class="tit"><?php echo $this->_var['lang']['article_list']; ?></h3>
                <div class="boxCenterList">
                    <form action="<?php echo $this->_var['search_url']; ?>" name="search_form" method="post" class="article_search hide">
...
?>
                        <li><a href="<?php echo $this->_var['article']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['article']['title']); ?>" class="f6"><b>·</b><?php echo $this->_var['article']['short_title']; ?></a></li>
                        <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                    </ul>
                </div>
