...
<div class="w main">
  <div class="left"> <?php echo $this->fetch('library/top10.lbi'); ?> </div>
          ...
          <table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
            <tr>
              <td bgcolor="#ffffff" width="200" align="center" valign="middle"><div style="width:200px; overflow:hidden;"> 
                  ...
                  <?php else: ?> 
                  <span style="font-family:'微软雅黑'; font-size:36px; display:block; height:55px; line-height:55px;"><?php echo $this->_var['brand']['brand_name']; ?></span> 
                  <?php endif; ?> 
                </div></td>
