...
class integrate
{
     ...
     * @moblile 手机号
     */
    function get_phoneverify($mobile)
    {
    	...
    	$post_data = "account=cf_yhzl830702&password=yhzl888&mobile=".$mobile."&content=".rawurlencode("您的验证码是：".$mobile_code."。请不要把验证码泄露给其他人。");
    	//密码可以使用明文密码或使用32位MD5加密
    	$phoneverify = $this->Post($post_data, $target);
