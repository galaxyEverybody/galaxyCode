...
?><i></i></div>
            <div class="themes Category">
            	<ul>
                    <?php $_from = $this->_var['goods_cat']['cat_clild']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_09714100_1435015365');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_09714100_1435015365']):
        $this->_foreach['foo']['iteration']++;
?>
                    <?php if ($this->_foreach['foo']['iteration'] < 7): ?>
                    <!--<li class="fore<?php echo $this->_foreach['foo']['iteration']; ?>"><a href="<?php echo $this->_var['cat_0_09714100_1435015365']['url']; ?>"><i></i><span><?php echo $this->_var['cat_0_09714100_1435015365']['name']; ?></span></a></li>-->
                    <?php endif; ?>
                    <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                </ul>
            </div>
