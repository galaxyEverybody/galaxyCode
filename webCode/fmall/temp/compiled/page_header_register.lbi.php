...
<div class="w w1 header clearfix">
	<div id="logo"><a href="./index.php"><img src="themes/jingdong2015/images/logo.gif" title="返回<?php echo $this->_var['shop_name']; ?>首页" alt="返回<?php echo $this->_var['shop_name']; ?>首页"></a></div>
</div>