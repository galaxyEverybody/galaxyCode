...
?>
                ...
                <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_30450600_1435014491');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_30450600_1435014491']):
?>
                <?php $_from = $this->_var['filter_attr_0_30450600_1435014491']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('key', 'attr');if (count($_from)):
    foreach ($_from AS $this->_var['key'] => $this->_var['attr']):
?>
                <?php if ($this->_var['attr']['selected'] && $this->_var['key'] > 0): ?>
                <a href="<?php echo $this->_var['attr']['del_url']; ?>"><?php echo htmlspecialchars($this->_var['filter_attr_0_30450600_1435014491']['filter_attr_name']); ?>：<strong><?php echo $this->_var['attr']['attr_value']; ?></strong><b></b></a>
                <?php endif; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
                <?php endif; ?>
...
?> 
                ...
                <?php $_from = $this->_var['filter_attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'filter_attr_0_30522100_1435014491');if (count($_from)):
    foreach ($_from AS $this->_var['filter_attr_0_30522100_1435014491']):
?>
                <?php if (! $this->_var['filter_attr_0_30522100_1435014491']['selected']): ?>
                <div class="prop-attrs">
                	<div class="attr">
                    	<div class="a-key"><font><?php echo htmlspecialchars($this->_var['filter_attr_0_30522100_1435014491']['filter_attr_name']); ?></font>：</div>
                        <div class="a-values">
                        	<div class="v-fold">
                            	<ul class="f-list">
                                	<?php $_from = $this->_var['filter_attr_0_30522100_1435014491']['attr_list']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'attr');if (count($_from)):
