...
<div class="w">
	<div id="floorList">
        ...
        <div class="mc" data-widget="tabs">
        	<?php $_from = $this->_var['on_top_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'top_goods_0_12427200_1435048847');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from AS $this->_var['top_goods_0_12427200_1435048847']):
        $this->_foreach['foo']['iteration']++;
?>
        	<?php $_from = $this->_var['top_goods_0_12427200_1435048847']['goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['foo2'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo2']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['foo2']['iteration']++;
?>
            ...
            <div class="oaFloor">
            	<div class="catalogue fl" title="<?php echo $this->_var['top_goods_0_12427200_1435048847']['cat_name']; ?>"><?php 
$k = array (
  'name' => 'ads_pro',
  'cat_name' => $this->_var['top_goods_0_12427200_1435048847']['cat_name'],
  'type' => '分类左侧广告',
);
echo $this->_echash . $k['name'] . '|' . serialize($k) . $this->_echash;
?><h3><?php echo $this->_var['top_goods_0_12427200_1435048847']['cat_name']; ?></h3></div>
                <div class="con fr">
                	<div class="c-top">
...
?></a></li>
                        ...
                        <div class="f_l showAd">
                        	<ul>
                            	<?php $_from = $this->_var['top_goods_0_12427200_1435048847']['goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods');$this->_foreach['foo'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['foo']['total'] > 0):
    foreach ($_from AS $this->_var['goods']):
        $this->_foreach['foo']['iteration']++;
?>
