...
?>
                    ...
                    <div class="item" id="authcodeDiv">
                        ...
                        <div class="fl item-ifo">
                            ...
                            <label class="img"> <img src="captcha.php?<?php echo $this->_var['rand']; ?>" alt="captcha" style="cursor:pointer;width:100px;height:38px;display:block; margin-left:10px;"  onClick="this.src='captcha.php?'+Math.random()" /> </label>
                        </div>
                    </div>
                    <?php endif; ?>
