...
?>
            ...
            <li class="fore3 ld menu" id="app-jd" style="display:none;">
            	<div class="dt"><s></s><i></i><span class="outline"></span><span class="blank"></span><a href="#" target="_blank">手机富猫</a><b></b></div>
                <div class="dd lh">
...
<div id="o-header-2013">
	<div class="w" id="header-2013">
    	<div id="logo-2013" class="ld"><a href="./index.php" hidefocus="true" ><img src="themes/jingdong2015/images/logo.gif" alt="银河众联"></a></div>
...
?>
                ...
                <a href="search.php?keywords=<?php echo urlencode($this->_var['val']); ?>" target="_blank" style="color:#ff500b"><?php echo $this->_var['val']; ?></a>
                <?php else: ?>
        ...
        <div id="my360buy-2013" class="hide">
        	<dl>
            	<dt class="ld"><s></s><a href="user.php">我的银河众联</a><b></b></dt>
                <dd>
                	<div class="prompt"> <span class="fl"><strong></strong></span> <span class="fr"><a href="user.php">去我的银河众联首页&nbsp;&gt;</a></span> </div>
