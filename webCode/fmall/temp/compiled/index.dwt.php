...
<?php $this->assign('cat_goods',$this->_var['cat_goods_998']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_998']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
<?php $this->assign('cat_goods',$this->_var['cat_goods_1009']); ?><?php $this->assign('goods_cat',$this->_var['goods_cat_1009']); ?><?php echo $this->fetch('library/cat_goods.lbi'); ?>
...
<div id="elevator" class="elevator" >
    <ul>
        ...
        <li ><span class="lou">2F</span><span class="text">债券</span></li>
