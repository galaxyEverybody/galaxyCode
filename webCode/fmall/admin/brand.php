...
function get_brandlist()
{
    ...
    while ($rows = $GLOBALS['db']->fetchRow($res))
    {
        $brand_logo = empty($rows['brand_logo']) ? '' :
            '<a href="../' . DATA_DIR . '/brandlogo/'.$rows['brand_logo'].'" target="_brank"><img src="../' . DATA_DIR . '/brandlogo/'.$rows['brand_logo'].'" width="" height="39" border="0" alt='.$GLOBALS['_LANG']['brand_logo'].' /></a>';
