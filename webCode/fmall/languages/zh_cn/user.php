...
$_LANG['label_order_invest'] = '散标投资';
$_LANG['label_order_investabs'] = '聚能赚定期';
...
$_LANG['widthdrawpw_error'] = '-提现密码错误!';
$_LANG['recharge_no_num'] = '-信息缺失';
$_LANG['withdraws_idandcard_fail'] = '-您还没有进行实名认证或银行卡的绑定';
...
$_LANG['withdrawpw_success'] = '-提现密码设置成功';
$_LANG['withdrawpw_fail'] = '-提现密码设置失败,请重新输入！';
$_LANG['rechanger_success'] = '+充值成功';
...
$_LANG['userhead_upload_fail'] = '-文件上传失败,请重新上传';
$_LANG['userhead_upload_success'] = '-文件上传成功';
...
$_LANG['bang_card_exist'] = '您输入卡号与开户行不一致！';
...
$_LANG['message_type'] = '建议类型';
$_LANG['message_content'] = '建议内容';
...
$_LANG['msg_phone_blank'] = '手机号不能为空';
$_LANG['msg_phone_registered'] = '手机号已存在,请重新输入';
$_LANG['msg_phone_format'] = '手机号格式不正确';
...
$_LANG['your_surplus'] = '账户余额';
$_LANG['credit_line'] = '信用额度';
$_LANG['your_bonus'] = '红包';
$_LANG['your_message'] = '留言';
$_LANG['your_order'] = '订单';
$_LANG['your_integral'] = '冻结金额';
...
$_LANG['passport_js']['email_confirm'] = 'Email 已存在请重新输入';
$_LANG['passport_js']['truename_empty'] = '真实姓名不可以为空！';
$_LANG['passport_js']['truename_invalid'] = '真实姓名不合法！';
$_LANG['passport_js']['idcard_empty'] = '身份证号不可以为空！';
$_LANG['passport_js']['idcard_invalid'] = '身份证号不合法！';
$_LANG['passport_js']['idcard_confirm'] = '该身份证号在系统中已存在！';
$_LANG['passport_js']['idcard_success'] = '实名认证成功';
$_LANG['passport_js']['newphone_empty'] = '新手机号不可以为空！';
$_LANG['passport_js']['newphone_invalid'] = '新手机号不合法！';
$_LANG['passport_js']['agreement'] = '您没有接受协议';
$_LANG['passport_js']['phone_verify'] = '无效的短信验证码';
