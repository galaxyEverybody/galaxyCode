...
$_LANG['passport_js']['truename_empty'] = '真实姓名为空';
$_LANG['passport_js']['truename_invalid'] = '真实姓名不合法';
$_LANG['passport_js']['idcard_empty'] = '身份证号为空';
$_LANG['passport_js']['idcard_invalid'] = '身份证号不合法';
$_LANG['passport_js']['idcard_confirm'] = '身份证号输入错误请重新输入';
$_LANG['passport_js']['idcard_success'] = '实名认证成功';
$_LANG['passport_js']['newphone_empty'] = '新手机号为空';
