...
{
	var borrowname = $("input[name='borrowname']")[0].value;
	var borrowphone = $("input[name='borrowphone']")[0].value;
	var borrownum = $("input[name='borrownum']")[0].value;
	var phoneverify = $("input[name='phoneverify']")[0].value;
	if(borrowname == ''){
		$("#borrowname").html('真实姓名不可以为空');
		return false;
	}
	if(borrowphone == ''){
		$("#borrowphone").html('手机号不可以为空');
		return false;
	}
	if(borrownum == ''){
